package qmui.widget.roundwidget;
 ...
 * </p>
 */
public class QMUIRoundTextView extends TextView {
    ...
    public QMUIRoundTextView(Context context, AttributeSet attrs) {
        super(context, attrs, R.attr.QMUIButtonStyle);
        init(context, attrs, R.attr.QMUIButtonStyle);
    }

    public QMUIRoundTextView(Context context, AttributeSet attrs, int defStyleAttr) {
